...
if (class_exists('WP_Customize_Control') && !class_exists('vdequator_Plugin_Install_Control')) {
	/**
	 *
	 * @see WP_Customize_Section
	 */
	class vdequator_Plugin_Install_Control extends WP_Customize_Control {
		/**
		 ...
		 * @var string
		 */
		public $type = 'vdequator_plugin_install_control';
		public $name = '';
		public $slug = '';
		...
		protected function render_content() {
			...
			$vdequator_hide_install_this = get_option('vdequator_hide_customizer_notice_'.$this->slug,  false);
			if($vdequator_hide_install_this){
				return;
			}

			global $vdequator_about_page;
			if(!is_object($vdequator_about_page)){
				return;
			}
...
function vdequator_hide_customizer_notice(){
...
add_action('wp_ajax_webriti_hide_customizer_notice', 'vdequator_hide_customizer_notice');